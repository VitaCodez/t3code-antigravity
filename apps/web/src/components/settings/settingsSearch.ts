...
export const SETTINGS_SEARCH_ITEMS = [
  ...
  },
  {
    ...
    to: "/settings/appearance",
    searchTerms: ["wallpaper background photo capy cyberpunk image art atmosphere backdrop"],
    targetId: "appearance-wallpaper",
  },
  {
    id: "wallpaper-opacity",
    title: "Wallpaper brightness",
    to: "/settings/appearance",
    searchTerms: ["wallpaper opacity brightness dimming contrast"],
    targetId: "appearance-wallpaper",
  },
  {
    id: "wallpaper-blur",
    ...
    to: "/settings/appearance",
    searchTerms: ["wallpaper blur background focus soften"],
    targetId: "appearance-wallpaper",
  },
  {
  ...
  },
  {
    ...
    to: "/settings/appearance",
    searchTerms: ["pixelated pixel art 8-bit crisp retro smoothing"],
    targetId: "appearance-wallpaper",
  },
  {
    id: "wallpaper-auto-accent",
    title: "Auto-accent from wallpaper",
    to: "/settings/appearance",
    searchTerms: ["wallpaper accent ambient tint color glow neon match"],
    targetId: "appearance-wallpaper",
  },
  {
    id: "retro-font-preset",
    title: "Retro / Pixel font",
    to: "/settings/appearance",
    searchTerms: [
      "retro pixel font typography vt323 press start silkscreen monospace crt terminal",
    ],
    targetId: "appearance-wallpaper",
  },
  {
